...
while True:
    for line in ser.read():
        ...
        if(line == 13):
            ...
            if (string[11] == '1'): print("Thumb")
            if (string[11] == '2'): print("Index Finger")
            if (string[11] == '3'): print("Middle Finger")
            if (string[11] == '4'): print("Ring Finger")
            if (string[11] == '5'): print("Little Finger")
            string = ""
